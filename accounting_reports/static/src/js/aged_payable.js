...
export class AgedPayableReport extends Component {
    static template = "accounting_reports.AgedPayable";
    static props = ["*"];
    ...
    onExportExcel() {
        ...
        link.download = `aged_payable_${this.state.asOfDate}.csv`;
        link.click();
    }
    ...
    openPartnerLedger(partnerId) {
        this.actionService.doAction({
            ...
            context: {
                ...
                default_account_type: 'liability_payable',
            },
        });
    }
...
AgedPayableReport.template = "accounting_reports.AgedPayable";
registry.category("actions").add("aged_payable_report", AgedPayableReport);
