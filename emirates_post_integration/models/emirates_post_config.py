...
class EmiratesPostConfig(models.Model):
    ...
    def test_connection(self):
        ...
        try:
            ...
            # Remove /genericapi for lookups endpoint
            if base_url.endswith('/genericapi'):
                base_url = base_url.replace('/genericapi', '')

            url = f"{base_url}/lookups/rest/GetEmiratesDetails"
