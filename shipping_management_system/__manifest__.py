# -*- coding: utf-8 -*-
{
    ...
    'web.assets_backend': [
        ...
        'shipping_management_system/static/src/xml/shipment_dashboard.xml',  # Template أولاً
        'shipping_management_system/static/src/js/shipment_dashboard.js',    # Component ثانياً
        'shipping_management_system/static/src/css/dashboard.css',           # Styles
    ],
    'web.assets_frontend': [
