...
class ShipmentWebsite(http.Controller):
    ...
    def shipment_submit(self, **post):
        ...
        required_fields = [
            'sender_name', 'sender_phone', 'sender_address', 'sender_governorate_id',
            'recipient_name', 'recipient_phone', 'recipient_address', 'recipient_governorate_id', 'recipient_city'
        ]
        ...
        for key in post.keys():
            if key.startswith('products[') and '[name]' in key:
                ...
                product = {
                    ...
                    'brand_id': post.get(f'products[{index}][brand_id]'),
                    ...
                    'dangerous_goods': post.get(f'products[{index}][dangerous_goods]') == 'on',
                }
        ...
        try:
            ...
            sender_partner = self._create_or_get_partner(
                ...
                street2=post.get('sender_district'),
                city=post.get('sender_city'),
                state_id=safe_int(post.get('sender_governorate_id')),
                country_id=egypt_id
            )
            ...
            recipient_partner = self._create_or_get_partner(
                ...
                street2=post.get('recipient_district'),
                city=post.get('recipient_city'),
                state_id=safe_int(post.get('recipient_governorate_id')),
                country_id=egypt_id
            )
            ...
            shipment_vals = {
                ...
                'sender_governorate_id': safe_int(post.get('sender_governorate_id')),
                ...
                'recipient_governorate_id': safe_int(post.get('recipient_governorate_id')),
            ...
            for product in products_data:
                line_vals = {
                    ...
                    'dangerous_goods': product.get('dangerous_goods', False),
                }
