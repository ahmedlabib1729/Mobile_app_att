...
class ShipmentPortal(CustomerPortal):
    ...
    class ToroodWebsite(http.Controller):
        ...
        def torood_homepage(self, **kwargs):
            """عرض الصفحة الرئيسية لشركة طرود"""
            # يمكنك إضافة أي بيانات تريد تمريرها للصفحة
            values = {
                'company_name': 'طرود',
                'company_name_en': 'Torood',
                # إحصائيات (يمكن جلبها من قاعدة البيانات)
                'total_customers': 10000,
                'monthly_shipments': 50000,
                'governorates': 27,
                'satisfaction_rate': 99,
            }

            return request.render('shipping_management_system.torood_homepage', values)
