...
class ShipmentOrder(models.Model):
    ...
    def _compute_customer_pricing(self):
        ...
        for record in self:
            ...
            # 2. المبلغ القابل للخصم = total_company_cost فقط (يشمل كل شيء بالفعل)
            record.discountable_amount = record.total_company_cost  # لا نضيف additional_fees لأنها موجودة بالفعل
