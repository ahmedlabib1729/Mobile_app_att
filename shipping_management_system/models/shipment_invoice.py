...
class ShipmentOrder(models.Model):
    ...
    def _prepare_invoice_values(self):
        ...
        final_amount = self.total_company_cost + self.total_additional_fees - self.discount_amount
        ...
        if self.total_additional_fees > 0:
            narration_lines.append(f'Additional Services: {self.total_additional_fees:.2f} EGP')
        narration_lines.append(f'Shipping Cost: {self.shipping_cost:.2f} EGP')
        ...
        narration_lines.append(f'Total Amount: {final_amount:.2f} EGP')
        ...
        if self.payment_method == 'cod':
            ...
            net_return = self.cod_amount - final_amount
            if net_return > 0:
                narration_lines.append(f'Net amount to return after deducting our fees: {net_return:.2f} EGP')
            elif net_return < 0:
                narration_lines.append(f'Additional amount to collect: {abs(net_return):.2f} EGP')
