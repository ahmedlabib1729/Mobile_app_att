...
class ShipmentOrder(models.Model):
    ...
    def _prepare_invoice_values(self):
        """تحضير قيم فاتورة العميل - سطر واحد فقط"""
        self.ensure_one()
    ...
    def _prepare_invoice_line_discount(self):
        ...
        discountable = self.total_company_cost + self.total_broker_fees
