...
class TaxDeclaration(models.Model):
                ...
                if record.period_type == 'monthly':
                    ...
                    if record.tax_type == 'vat' and record.client_id:
                        ...
                        if setting and setting.tax_year_start_date:
                            ...
                            # حساب الأشهر للربع المطلوب
                            # إذا بداية السنة الضريبية في أبريل مثلاً:
                            # Q1: أبريل - يونيو
                            # Q2: يوليو - سبتمبر
                            # Q3: أكتوبر - ديسمبر
                            # Q4: يناير - مارس (السنة التالية)
                            ...
                            # النظام العادي إذا لم يكن هناك تاريخ بداية
                        ...
                        # النظام العادي للضرائب الأخرى (يناير - مارس، أبريل - يونيو، إلخ)
                        start_month = (period_num - 1) * 3 + 1
                        end_month = period_num * 3
    ...
    def action_send_reminder(self):
        """إرسال تذكير يدوي للعميل (للتوافق مع النظام القديم)"""
        self.ensure_one()
        # تحديد أي تذكير سيتم إرساله
    ...
    def _send_reminder(self, reminder_type):
        ...
        if template_id:
            try:
                # إضافة معلومات التذكير في السياق
